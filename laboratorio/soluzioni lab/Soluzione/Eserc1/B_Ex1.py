...
counter_test_positivi += tester_fun(B_Ex1, ["arcierenero","pompierenero"], 8)
counter_test_positivi += tester_fun(B_Ex1, ["arcieretre","pippore"], 2)
counter_test_positivi += tester_fun(B_Ex1, ["pompiere",""] , 0)
counter_test_positivi += tester_fun(B_Ex1, ["mare","mammare"] , 4)
counter_test_positivi += tester_fun(B_Ex1, ["reggimenti","mento"] , 0)
